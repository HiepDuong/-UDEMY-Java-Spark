package com.pairRDDs.sortByKey;
import com.RDDSpark.utils.Utils;
import com.pairRDDs.reduceByKey.AvgCount;
...
public class AverageHousePriceProblemSort {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        SparkConf conf = new SparkConf().setAppName("averageHosueSort").setMaster("local[2]");
        ...
        JavaPairRDD<Double, String> sortedAverageHousePrice = averageOfEachHouse.mapToPair(line -> new Tuple2<>(line._2(), line._1())).sortByKey(true);

        JavaPairRDD<String,Double>  roomToPricePairSorted = sortedAverageHousePrice.mapToPair(line -> new Tuple2<>(line._2(), line._1()));
        //ACTION
        for (Tuple2<String, Double> entry : roomToPricePairSorted.collect()){
            System.out.println("No Of Room: "+ entry._1() + " " +"Pricce: "+ entry._2());
        }
    }
